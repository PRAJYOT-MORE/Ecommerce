...
public class PlaceOrderDetailsPojo {
	...
	public PlaceOrderDetailsPojo() {
		super();
	}	
	public PlaceOrderDetailsPojo(int productsn, int count, String title, String description, String crossprice,
