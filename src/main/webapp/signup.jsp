					...
					<div class="card-body p-0">
						<div class="row no-gutters">
							<div class="col-lg-6">
								<div class="p-5">
									<div class="mb-5">
										<h3 class="h4 font-weight-bold text-theme">User Signup</h3>
	<h3 style="color: red;" ><%@include file="messagebox/message.jsp" %></h3>
									</div>
									<h6 class="h5 mb-0">Welcome!</h6>
									<p class="text-muted mt-2 mb-5">Enter your details</p>
								
   
						<form action="usersignup" method="post">
										<div class="form-group">
											<label for="exampleInputName1">Full Name</label> 
						<input name="fullname" type="text" class="form-control" id="exampleInputName1" required="required">
										</div>
										
										<div class="form-group mb-5">
											<label for="exampleInputMobile1">Mobile (10 Digits)</label> 
						<input name="mobile"  type="text" pattern="[0-9]{10}" class="form-control" id="exampleInputMobile1" required="required">
										</div>
						...
						<input name="confirmpassword" type="password" class="form-control" id="exampleInputPassword2" required="required">
										</div>
